...
class AppUi:
  def __init__(self, environment_service: EnvironmentService, map_repository: MapRepository, terrain_repository: TerrainRepository):
  ...
  def start(self, page: flet.Page):
    ...
    view_service.register(PlayAgentPositionSelectionViewUi(self.__environment_service))
